...
from Jarvis.features import objectdetection
from Jarvis.features import sign_detector
...
class JarvisAssistant:
    ...
    def tell_me(self, topic):
        ...
        """
        return WikipediaSearch.tell_me_about(topic)
    ...
    def objStope(self):
        objectdetection.stop_obj_detection()
    def signdector(self):
        sign_detector.start_sign_detection()
    def stopsing(self):
        sign_detector.stop_sign_detection()
